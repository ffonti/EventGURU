...
<div>
    ...
    <p>L'organizzatore ${nomeOrganizzatore} ${cognomeOrganizzatore} ha creato un nuovo evento, di seguito tutte le informazioni necessarie:</p>
    ...
    <p>Se non vuoi più ricevere email alla creazione di un evento da parte di ${nomeOrganizzatore} ${cognomeOrganizzatore},
        puoi tranquillamente smettere di seguirlo dalla sezione "Organizzatori" sulla nostra piattaforma.
    </p>
